define([
    ...
    'underscore',
    'backbone',
    'text!templates/picdebug.html',
    'collections/tagset',    
    'common'
], function($, _, Backbone, picDebugTemplate, TagSet, Common) {
    /**
     * The View object for a Picture in the grid.
     * The view object is a div
     */
    var PicDebugView = Backbone.View.extend({
        tagName: "div",
        
        template: _.template(picDebugTemplate),
